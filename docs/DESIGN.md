...
> Design notes for **fintech-signup-email-verification** — a runnable python example that Risk-aware email verification for a fintech checkout signup, with payment context and audit records.
...
- **Feature code** — the actual task: fintech-email-verification.
